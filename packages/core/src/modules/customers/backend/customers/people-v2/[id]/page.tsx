...
import { usePersonGuardedMutation } from './hooks/usePersonGuardedMutation'
...
export default function PersonDetailV2Page({ params }: { params?: { id?: string } }) {
  ...
  // Form submit/delete
  const { isSaving, handleFormSubmit, handleFormDelete, handleHeaderSave } = usePersonGuardedMutation({
    data,
    dataRef,
    organizationId,
    loadData,
